...
% Title block below can be changed, but {14}(8.5,-0.2) is about the
% biggest it can be before the box starts to overlap the occam logo
% and the thick page border.
\frameoff
%\begin{textblock}{14}(8.5,-0.2)
...
%%%%%   Column 4   %%%%%
% delete all these for a 3-column and edit occampostertemplate.tex
