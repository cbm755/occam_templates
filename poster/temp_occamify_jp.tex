...
\newenvironment{area1w}[1]{\textblockcolour{white}\begin{textblock}{8}(-0.875,#1)}{\end{textblock}}
\newenvironment{area1}[1]{\begin{textblock}{7.75}( -0.75,#1)}{\end{textblock}}
\newenvironment{area2}[1]{\begin{textblock}{7.75}( 7.5,#1)}{\end{textblock}}
\newenvironment{area3}[1]{\begin{textblock}{7.75}(15.75,#1)}{\end{textblock}}
\newenvironment{area4}[1]{\begin{textblock}{7.75}(24,#1)}{\end{textblock}}

% New commands (Put your 'newcommand's here)
\newcommand{\spc}{{\color{desert}c}}
\def\Subsubhead#1{{\color{occamdark}\bfseries#1}}
% Logos
