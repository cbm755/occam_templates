...
% this moves the logo to the top-right [Nick Hale, Colin Macdonald 2012-07-24]
\defbeamertemplate*{sidebar right}{upperlogo}
{
  \vskip6pt%
  \llap{\insertlogo\hskip0.08cm}%
  \vfill%
...
\logo{\includegraphics[width=0.26\textwidth]{img/logo-occam-combined-small}} % bottom-right
